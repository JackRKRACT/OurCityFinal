...
export default class TourismPin extends React.Component {
  ...
  handleSubmit(e) {
      ...
      let port = "5000"
      let url = host + ":" + port + "/submitTourismPin"
      axios({
          method: 'post',
          url: url,
          data: {
    ...
    return (
      <div>
        <Modal
          ...
          style={customStyles}
          contentLabel="New Tourist Pin Modal"
        >
          <div className="application">
            <h2>New Tourism Pin</h2>
            ...
            <ButtonGroup>
                <DropdownButton id="dropdown-basic-button" title="Type">
                    <Dropdown.Item onClick={this.handleType} id={"hotel"} name={"hotel"}>Hotels</Dropdown.Item>
                    <Dropdown.Item onClick={this.handleType} id={"rest"} name={"rest"}>Restaurants</Dropdown.Item>
                    <Dropdown.Item onClick={this.handleType} id={"atm"} name={"atm"}>ATMs</Dropdown.Item>
                    <Dropdown.Item onClick={this.handleType} id={"theatre"} name={"theatre"}>Theatres</Dropdown.Item> 
                    <Dropdown.Item onClick={this.handleType} id={"attraction"} name={"attraction"}>Tourist Attractions</Dropdown.Item> 
                </DropdownButton>
